...
if("FALSE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/team4/catkin_ws/src/cse481wi19/perception)
  set(perception_DEVEL_PREFIX /home/team4/catkin_ws/src/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'team4 <team4@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'team4 <team4@todo.todo>' to fix it.")
    endif()
    _list_append_unique(perception_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "perception_crop;perception_downsample;perception_segmentation;perception_box_fitter;perception_feature_extraction;perception_object_recognizer")
